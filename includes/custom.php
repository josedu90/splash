...
if (!function_exists('splash_sidebar_layout_mode')) {
    function splash_sidebar_layout_mode($position = 'left', $sidebar_id = false)
    {
        ...
        if (!$sidebar_id) {
            ...
            $contentW = (splash_is_layout('magazine_one') || splash_is_layout('hockey')) ? '8' : '9';
            $sidebarW = (splash_is_layout('magazine_one') || splash_is_layout('hockey')) ? '4' : '3';
...
function splash_is_af()
{
    ...
    return ($layoutName == 'af') ? true : false;
}
