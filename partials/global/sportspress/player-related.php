	...
	<div class="stm-player-ids <?php echo esc_attr($carousel_id); ?>">
		<div class="clearfix">
			<div class="stm-title-left">
				<h1 class="stm-main-title-unit"><?php esc_html_e('Related Players', 'splash'); ?></h1>
			</div>
	...
	<script type="text/javascript">
		(function($) {
			...
			$(document).ready(function () {
				owl.owlCarousel({
					items: <?php echo splash_is_layout('soccer_two') ? '3' : '4'; ?>,
					dots: false,
					autoplay: false,
					slideBy: <?php echo splash_is_layout('soccer_two') ? '3' : '4'; ?>,
					loop: true,
					responsive:{
						0:{
							items:1,
