...
<div class="<?php echo esc_attr($col); ?>">
    <div <?php post_class('stm-single-post-loop'); ?>>
        <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">
                ...
                <?php if (splash_is_layout('soccer_two') || !is_search()): ?>
                    <div class="image <?php if (get_post_format(get_the_ID())) echo get_post_format(get_the_ID()); ?>">
                        ...
                        <?php if (splash_is_layout("bb")) {
                            ...
                            (get_the_post_thumbnail_url(get_the_ID(), 'post-720-440', array('class' => 'img-responsive'))) ? the_post_thumbnail('post-720-440', array('class' => 'img-responsive')) : the_post_thumbnail('full', array('class' => 'img-responsive'));
                        } else {
            ...
            <?php if (!splash_is_layout("sccr") && !splash_is_layout("hockey") && !splash_is_layout("bb")): ?>
        ...
        <?php if (!splash_is_af() && !splash_is_layout('soccer_two') && !splash_is_layout('basketball_two')): ?>
            <div class="content">
