    ...
    <div class="stm-team-staff-list">
        <div class="stm-team-staff-list-inner clearfix">
            <?php foreach ($members as $staff):
                ...
                if (!splash_is_af() && !splash_is_layout('basketball_two') && !splash_is_layout('hockey')):
                    ?>
                                            ...
                                            <table>
                                                <?php if (get_post_meta($id, 'staff_age') != null): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php $age = get_post_meta($id, 'staff_age');
                                                            echo esc_html($age[0]); ?></td>
                                                    </tr>
                                                <?php endif; ?>
                                                <?php if (get_post_meta($id, 'staff_college') != null): ?>
                                                    <tr>
                                                        <td><?php esc_html_e('College:', 'splash'); ?></td>
                                                        <td><?php $collage = get_post_meta($id, 'staff_college');
                                                            echo esc_html($collage[0]); ?></td>
                                                    </tr>
                                                <?php endif; ?>
                                                <?php if (get_post_meta($id, 'staff_experience') != null): ?>
                                                    <tr>
                                                        <td><?php esc_html_e('Experience:', 'splash'); ?></td>
                                                        <td><?php $experience = get_post_meta($id, 'staff_experience');
                                                            echo esc_html($experience[0]); ?></td>
                                                    </tr>
                                                <?php endif; ?>
                                                <tr>
