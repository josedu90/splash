...
?>
    <div class="stm-player-ids <?php echo esc_attr($view_style) =='style_2' ? 'style_2 ':''; echo esc_attr($id); ?>">
        <div class="clearfix">
            <?php if (!empty($title)): ?>
                            ...
                            <?php else : ?>
                                <div class="stm-player-wrapp">
                                    <div class="player_image">
                                        <a href="<?php echo esc_url(get_the_permalink($player_id)); ?>">
                                            <img src="<?php echo splash_get_thumbnail_url($player_id, 0, 'blog_list'); ?>"
                                                 alt="<?php echo get_the_title($player_id); ?>"/>
                                        </a>
                                    </div>
